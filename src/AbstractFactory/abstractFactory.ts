export namespace AbstractFactoryPattern {
    ...
    export class ProductA1 implements AbstractProductA {
        public methodA = () => {
            return "这是ProductA1里面的methodA方法";
        }
    }
    ...
    export class ProductA2 implements AbstractProductA {
        public methodA = () => {
            return "这是ProductA2里面的methodA方法";
        }
    }
    ...
    export class ConcreteFactory1 implements AbstractFactory {
        public createProductA(param?: any): AbstractProductA {
            return new ProductA1();
        }

        public createProductB(param?: any): AbstractProductB {
